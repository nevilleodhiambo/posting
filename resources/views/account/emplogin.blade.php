  ...
  <div class="container mt-5">
    <div class="background-div">
      <div class="left-content">
        ...
        <p>Enter Your Company Email and Password to Login</p>
      </div>
          ...
          <form method="POST" action="{{route('emplogin')}}">
            ...
            <div class="row">
                <div class="col mb-3">
                    ...
                    <input type="email" class="form-control" placeholder="Enter your Email" name="wemail">
                    <span style="color: red">@error('wemail'){{$message}}
